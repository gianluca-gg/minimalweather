...
let humidity = document.querySelector(".weatherIndicatorUmidity>.value");
...
let weatherApiKey = "77895ff33eb3905522e477af4f79f1f0";
...
let updateForecast = (forecast) => {
  ...
  forecast.forEach((day) => {
    ...
    <p class="weatherForecastTemperature"><span class="value">${temperature}</span></p>
  </article>`;
